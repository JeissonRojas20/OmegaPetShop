            ...
            <div className="max-w-md w-full p-6 bg-white rounded-lg shadow-lg">
                ...
                <form onSubmit={login}>
                    ...
                    <div className="mb-6">
                        ...
                        <input type="password" id="password" name="password" value={formData.password} onChange={handleChange} className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500" required />
